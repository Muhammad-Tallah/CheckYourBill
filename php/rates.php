<a href="?rates=true" class="btn btn-outline-primary m-3 float-end">Rates</a>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="?editrates=true&id=<?= $data['id']?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                Edit
                                            </a>
                                        </td>
                                    </tr>
